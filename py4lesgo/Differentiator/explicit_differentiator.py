...
from .explicit_first import differentiateSecondOrderFiniteDifference as first_der_SecondOrder
from .explicit_first import differentiateFourthOrderFiniteDifference as first_der_FourthOrder
from .explicit_first import differentiateSixthOrderFiniteDifference as first_der_SixthOrder
from .explicit_second import differentiateSecondOrderFiniteDifference as second_der_SecondOrder
from .explicit_second import differentiateFourthOrderFiniteDifference as second_der_FourthOrder
from .explicit_second import differentiateSixthOrderFiniteDifference as second_der_SixthOrder
...
class ExplicitDifferentiator(object):
    ...
    def ddx(self, data, der=None, component_idx=None, use_one_sided=False):
        ...
        if self._order[0] == 2:
            der[[slice(None)]*self._dim] = first_der_SecondOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
        elif self._order[0] == 4:
            der[[slice(None)]*self._dim] = first_der_FourthOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
        elif self._order[0] == 6:
            der[[slice(None)]*self._dim] = first_der_SixthOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
    ...
    def d2dx2(self, data, der=None, component_idx=None, use_one_sided=False):
        ...
        if self._order[0] == 2:
            der[[slice(None)]*self._dim] = second_der_SecondOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
        elif self._order[0] == 4:
            der[[slice(None)]*self._dim] = second_der_FourthOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
        elif self._order[0] == 6:
            der[[slice(None)]*self._dim] = second_der_SixthOrder(\
                data, self._dx, 0, component_idx, use_one_sided, self._dim, self._data_order)
